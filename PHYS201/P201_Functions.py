...
def quadratic_fit_plot_errors_core(xi,yi,labelstring="Quadratic Fit",linestring="r-"):
...
def quadratic_fit_plot_errors(xi,yi,x_low="",x_high="",labelstring="Quadratic Fit",linestring="r-"):
    if x_low=="":
        # Takes the x and y values to make a trendline
        a,b,c,da,db,dc = quadratic_fit_plot_errors_core(xi,yi,labelstring,linestring)
        ...
        if x_high=="":
            ...
            y_data_cut = np.array(y_data_cut)
            # Takes the x and y values to make a trendline
            a,b,c,da,db,dc = quadratic_fit_plot_errors_core(x_data_cut,y_data_cut,labelstring,linestring)
